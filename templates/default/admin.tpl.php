...
<head>
	...
	<link rel="shortcut icon" href="/templates/default/images/fav.png" type="image/x-icon">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="cp_top_line">
            ...
            <ul id="right_links">
                ...
                <li><a href="<?php echo href_to_home(); ?>" target="_blank"><?php echo LANG_CP_BACK_TO_SITE; ?></a></li>
    ...
    <div id="cp_footer">
        <div class="container">
            SG-games &copy; 2016. v<?php echo cmsCore::getVersion(); ?>
        </div>
    </div>
