...
<div class="content_item <?php echo $ctype['name']; ?>_item">
    ...
    <?php foreach($fields as $name=>$field){ ?>
        ...
        ?>
		<?php if($field['type'] == 'file' && $field['name'] == 'gamefile' && isset($field['gamefile'])) { ?>
			<div style="text-align:center;">
				<object width="100%" height="595" type="application/x-shockwave-flash" data="<?php echo $field['gamefile']; ?>"><param name="movie" value="<?php echo $field['gamefile']; ?>" /></object>
			</div>
		<?php } else { ?>
